...
def calculate_demographic_data(print_data=True):
    ...
    higher_education_50k = len(
        df[((df["education"] == "Bachelors") |
            (df["education"] == "Masters") |
            (df["education"] == "Doctorate")
            ) & (df["salary"] == ">50K")])
    lower_education_50k = len(
        df[~((df["education"] == "Bachelors") |
            (df["education"] == "Masters") |
            (df["education"] == "Doctorate")
            ) & (df["salary"] == ">50K")])
    ...
    highest_earning_country_percentage = round(df[df["native-country"]==highest_earning_country]["salary"].value_counts(normalize=True)[1]*100,1)
